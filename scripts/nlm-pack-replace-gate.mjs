...
// ---------------------------------------------------------------------------
// Legacy pack-family purge helpers (purgePackFamilyBeforeUpload)
// Used by notebooklm-uploader.js as a simpler alternative to replaceGate()
// above; kept alongside it since both are wired into live call sites.
// ---------------------------------------------------------------------------
