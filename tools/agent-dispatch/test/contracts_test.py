...
class ContractSchemaTests(unittest.TestCase):
    ...
    def test_zero_cost_route_accepts_exact_flat_policy(self):
        contract = valid_contract()
        contract["recommended_route"] = {
            "provider": "subscription-cli",
            "model": "configured",
            "execution_mode": "local_cli",
            "cost_policy": {"flat": 0},
            "credential_ref": "subscription-cli",
        }
    ...
    def test_zero_cost_contract_rejects_billable_allowed_routes(self):
        contract = valid_contract()
        contract["allowed_routes"] = [{
            "provider": "openrouter",
            "model": "paid-model",
            "execution_mode": "openrouter_http",
            "cost_policy": {"input_per_1k": 0.001, "output_per_1k": 0.002},
