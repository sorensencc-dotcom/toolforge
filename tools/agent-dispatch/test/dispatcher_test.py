...
class DispatcherTests(unittest.TestCase):
    ...
    def test_recommendation_precedes_first_attempt_and_fallback_stops_on_success(self):
        ...
        result = dispatch(self.contract, {"adapters": {"ollama": adapter}, "announce": lambda route: events.append("announce")})
    ...
    def test_operator_cannot_select_out_of_contract_route(self):
        ...
        result = dispatch(self.contract, {"operator_override": True, "operator_routes": [bad], "adapters": {}})
    ...
    def test_attempts_are_bounded_at_three(self):
        ...
        result = dispatch(contract, {"adapters": {str(i): lambda r, t, c: {"status": "failed"} for i in range(4)}})
