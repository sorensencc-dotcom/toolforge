...
const META_CODE = `return (function () {
  const headings = [...document.querySelectorAll('h1,h2,h3,h4,h5,h6')].slice(0, 200).map((node) => ({
    role: 'heading',
  ...
  const bodyText = document.body ? String(document.body.innerText || '').slice(0, 6000) : '';
  return {
