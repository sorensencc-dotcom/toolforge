...
export const ROOT_WIKI_PAGE_MAPPINGS = [
  ...
  { src: 'wiki/research/trm-devops-triage-pipeline.md', dest: 'trm-devops-triage-pipeline.md' },
  { src: 'wiki/research/trm-devops-triage-architecture.png', dest: 'trm-devops-triage-architecture.png' },
  { src: 'wiki/research/trm-devops-triage-architecture.html', dest: 'trm-devops-triage-architecture.html' },
