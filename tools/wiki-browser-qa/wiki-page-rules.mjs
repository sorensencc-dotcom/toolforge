...
export const ROOT_WIKI_PAGE_MAPPINGS = [
  ...
  { src: 'wiki/research/whichllm-architecture-topology.png', dest: 'research/whichllm-architecture-topology.png' },
  { src: 'wiki/research/whichllm-architecture-topology.html', dest: 'research/whichllm-architecture-topology.html' },
...
export const CLASSIFIED_WIKI_PAGES = [
  {
    ...
    requiredDiagrams: [{
      ...
      assetPattern: '(?:^|/)toolforge-architecture-overview\\.(?:html|png)$',
  ...
  },
  {
    ...
    requiredDiagrams: [{
      ...
      publishedAssetPath: 'toolforge-architecture-overview.png',
      requireAlt: true,
      requireCaption: true,
      viewports: visibleNonOverflowing,
    }],
